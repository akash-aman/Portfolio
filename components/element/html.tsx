export const U = (props) => {
	...
	if (props.className === "red-gradient" || props.className === "gradient-red") {
		return (
			<u className="u no-underline bg-gradient-to-r from-purple-400 to-pink-600 bg-[length:100%_2px] bg-no-repeat bg-bottom" >
				{props.children}
			</u>
		);
	}

	if (props.className === "green-gradient" || props.className === "gradient-green" || props.className === "gradient") {
		return (
			<u className="u no-underline bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-[length:100%_2px] bg-no-repeat bg-bottom" >
				{props.children}
			</u>
		);
	}
