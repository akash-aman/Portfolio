export const Span = (props) => {
	...
	if ( props.className === "gradient" || props.className === "gradient-red" || props.className === "red-gradient" ){

		return (
			<span {...props} className="span not-italic animate-gradient font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
				{props.children}
			</span>
		);
	}

	if ( props.className === "gradient-green" || props.className === "green-gradient" ){

		return (
			<span {...props} className="span not-italic animate-gradient font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-300 via-blue-500 to-purple-600">
				{props.children}
			</span>
		);
