...
export type RevalidateCourseQuery = {
	__typename?: "Query";
	course?: {
		__typename?: "CourseEntityResponse";
		data?: {
			...
			attributes?: {
				...
				chapters?: Array<{
					...
					chapter?: {
						...
						data?: {
							__typename?: "ChapterEntity";
							attributes?: { __typename?: "Chapter"; Slug: string } | null;
						} | null;
					} | null;
				} | null> | null;
			} | null;
 ...
 * });
 */
export function useBlogRoutesQuery(
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<BlogRoutesQuery, BlogRoutesQueryVariables>(
		BlogRoutesDocument,
		options,
	);
}
export function useBlogRoutesLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		BlogRoutesQuery,
		BlogRoutesQueryVariables
	>,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useLazyQuery<BlogRoutesQuery, BlogRoutesQueryVariables>(
		BlogRoutesDocument,
		options,
	);
}
export type BlogRoutesQueryHookResult = ReturnType<typeof useBlogRoutesQuery>;
export type BlogRoutesLazyQueryHookResult = ReturnType<
	typeof useBlogRoutesLazyQuery
>;
export type BlogRoutesQueryResult = Apollo.QueryResult<
	BlogRoutesQuery,
	BlogRoutesQueryVariables
>;
 ...
 * });
 */
export function useBlogsPageQuery(
	baseOptions?: Apollo.QueryHookOptions<
		BlogsPageQuery,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<BlogsPageQuery, BlogsPageQueryVariables>(
		BlogsPageDocument,
		options,
	);
}
export function useBlogsPageLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		BlogsPageQuery,
		BlogsPageQueryVariables
	>,
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useLazyQuery<BlogsPageQuery, BlogsPageQueryVariables>(
		BlogsPageDocument,
		options,
	);
}
export type BlogsPageQueryHookResult = ReturnType<typeof useBlogsPageQuery>;
export type BlogsPageLazyQueryHookResult = ReturnType<
	typeof useBlogsPageLazyQuery
>;
 ...
 * });
 */
export function useRevalidateCourseQuery(
	baseOptions: Apollo.QueryHookOptions<
	...
	const options = { ...defaultOptions, ...baseOptions };
	return Apollo.useQuery<RevalidateCourseQuery, RevalidateCourseQueryVariables>(
		RevalidateCourseDocument,
		options,
	);
}
export function useRevalidateCourseLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		RevalidateCourseQuery,
		RevalidateCourseQueryVariables
	>,
	...
	return Apollo.useLazyQuery<
		RevalidateCourseQuery,
		RevalidateCourseQueryVariables
	>(RevalidateCourseDocument, options);
}
export type RevalidateCourseQueryHookResult = ReturnType<
	typeof useRevalidateCourseQuery
>;
export type RevalidateCourseLazyQueryHookResult = ReturnType<
	typeof useRevalidateCourseLazyQuery
>;
export type RevalidateCourseQueryResult = Apollo.QueryResult<
	RevalidateCourseQuery,
	RevalidateCourseQueryVariables
>;
